...
var (
	filter_Greeting_Greet_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Greeting_Greet_0(ctx context.Context, marshaler runtime.Marshaler, client GreetingClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Greeting_Greet_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_Greeting_Greet_0(ctx context.Context, marshaler runtime.Marshaler, server GreetingServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GreetingRequest
	var metadata runtime.ServerMetadata
...
func RegisterGreetingHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GreetingServer) error {
	...
	mux.Handle("GET", pattern_Greeting_Greet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/build.Greeting/Greet")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Greeting_Greet_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Greeting_Greet_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGreetingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GreetingClient) error {
	...
	mux.Handle("GET", pattern_Greeting_Greet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/build.Greeting/Greet")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Greeting_Greet_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Greeting_Greet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"grpc", "greet"}, ""))
)

var (
	forward_Greeting_Greet_0 = runtime.ForwardResponseMessage
)
