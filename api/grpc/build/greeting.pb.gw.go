...
func local_request_Greeting_Greet_0(ctx context.Context, marshaler runtime.Marshaler, server GreetingServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Greeting_Greet_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_Greeting_Greet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"grpc", "greet"}, "", runtime.AssumeColonVerbOpt(true)))
)
